...
sudo nohup java ${JAVA_OPTS} -jar $DEPLOY_JAR --logging.file.path=/home/ec2-user/ --logging.level.org.hibernate.SQL=DEBUG --logging.level.org.springframework.web=DEBUG >> /home/ec2-user/action/teamdev/server/deploy.log 2>/home/ec2-user/action/teamdev/server/deploy_err.log &
